...
public class NavigationBar implements StencilObject, MouseEventListener, StencilStackChangeListener, LayoutChangeListener
{
  ...
  protected void createArrows(Point topCenter, int width) {
    ...
    backArrow.addPoint(x - 133 + 5, 36);
    backArrow.addPoint(x - 133 + 15, 26);
    backArrow.addPoint(x - 133 + 15, 32);
    backArrow.addPoint(x - 133 + 23, 32);
    backArrow.addPoint(x - 133 + 23, 40);
    backArrow.addPoint(x - 133 + 15, 40);
    backArrow.addPoint(x - 133 + 15, 46);
    ...
    forwardArrow.addPoint(x + width / 2 + 25 - 5, 36);
    forwardArrow.addPoint(x + width / 2 + 25 - 15, 26);
    forwardArrow.addPoint(x + width / 2 + 25 - 15, 32);
    forwardArrow.addPoint(x + width / 2 + 25 - 23, 32);
    forwardArrow.addPoint(x + width / 2 + 25 - 23, 40);
    forwardArrow.addPoint(x + width / 2 + 25 - 15, 40);
    forwardArrow.addPoint(x + width / 2 + 25 - 15, 46);
  ...
  protected int createShape(Point topCenter)
  {
    ...
    if (titleString != null) word = word + ": " + titleString;
    ...
    textAt.translate(x + width + 45, y + 18);
    s = wordLayout.getOutline(textAt);
    xShape = new ScreenShape(new Color(0, 0, 180), s, true, 7);
    
    wordLayout = new TextLayout("next", font, new FontRenderContext(null, false, false));
    textAt = new AffineTransform();
    textAt.translate(x + 7, y + 43);
    s = wordLayout.getOutline(textAt);
    ...
    textAt = new AffineTransform();
    textAt.translate(x + -110, y + 43);
    s = wordLayout.getOutline(textAt);
    prevShape = new ScreenShape(new Color(0, 0, 180), s, true, 8);
    
    wordLayout = new TextLayout("restart", font, new FontRenderContext(null, false, false));
    textAt = new AffineTransform();
    textAt.translate(x - wordLayout.getBounds().getWidth() - 10.0D, y + 43);
    s = wordLayout.getOutline(textAt);
    restartShape = new ScreenShape(new Color(0, 0, 180), s, true, 9);
    isModified = true;
    return width * 2;
  }
  ...
  protected void generateShapes()
  {
    ...
    underBar = new RoundRectangle2D.Double(x - width / 2 + 2, y + 2, width, 25.0D, 10.0D, 10.0D);
    underClose = new RoundRectangle2D.Double(x + width / 2 + 10 + 2, y + 2, 100.0D, 25.0D, 10.0D, 10.0D);
    underNext = new RoundRectangle2D.Double(x + 2, y + 2 + 27, 60.0D, 20.0D, 10.0D, 10.0D);
    underRestart = new RoundRectangle2D.Double(x + 3 - 65, y + 2 + 27, 60.0D, 20.0D, 10.0D, 10.0D);
    underPrev = new RoundRectangle2D.Double(x + 3 - 130, y + 2 + 27, 60.0D, 20.0D, 10.0D, 10.0D);
    ...
    bgBar = new RoundRectangle2D.Double(x - width / 2, y, width, 25.0D, 10.0D, 10.0D);
    bgClose = new RoundRectangle2D.Double(x + width / 2 + 10, y, 100.0D, 25.0D, 10.0D, 10.0D);
    bgNext = new RoundRectangle2D.Double(x, y + 27, 60.0D, 20.0D, 10.0D, 10.0D);
    bgRestart = new RoundRectangle2D.Double(x - 65, y + 27, 60.0D, 20.0D, 10.0D, 10.0D);
    bgPrev = new RoundRectangle2D.Double(x - 130, y + 27, 60.0D, 20.0D, 10.0D, 10.0D);
  ...
  public boolean intersectsRectangle(Rectangle rect) { return rect.intersects(getRectangle()); }
  ...
  public void removeStencilObjectPositionListener(StencilObjectPositionListener posListener) { stencilObjectPositionListeners.remove(posListener); }
  ...
  public void numberOfStencilsChanged(int newNumberOfStencils) { updateNavBar(); }
