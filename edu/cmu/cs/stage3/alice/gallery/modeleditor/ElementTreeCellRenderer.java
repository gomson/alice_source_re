...
class ElementTreeCellRenderer extends javax.swing.tree.DefaultTreeCellRenderer { ElementTreeCellRenderer() {}
  public java.awt.Component getTreeCellRendererComponent(javax.swing.JTree tree, Object value, boolean selected, boolean expanded, boolean leaf, int row, boolean hasFocus) { openIcon = (this.closedIcon = this.leafIcon = IconManager.lookupIcon(value));
