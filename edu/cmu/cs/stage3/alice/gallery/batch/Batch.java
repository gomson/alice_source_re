...
public abstract class Batch {
  public Batch() { m_world = new edu.cmu.cs.stage3.alice.core.World();
    m_world.name.set("World");
    
    initialize(m_world); }
  
  private edu.cmu.cs.stage3.alice.core.World m_world;
  public edu.cmu.cs.stage3.alice.core.World getWorld() { return m_world; }
  
  protected void initialize(edu.cmu.cs.stage3.alice.core.World world) {}
  
  public void forEachElement(File root, ElementHandler elementHandler) {
    ...
    File[] files = root.listFiles(new java.io.FilenameFilter() {
