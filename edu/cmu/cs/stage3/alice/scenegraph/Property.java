...
public class Property
{
  ...
  public Property(Class elementClass, String capsAndUnderscoresName, boolean isPersistent)
  {
    ...
    try
    {
      Class[] parameterTypes = { m_valueClass, HowMuch.class };
  ...
  public Property(Class elementClass, String capsAndUnderscoresName) { this(elementClass, capsAndUnderscoresName, true); }
  

  public boolean acceptsHowMuch() { return m_setterHowMuch != null; }
  
  public Object get(Object o) {
    Object[] getParameters = new Object[0];
    try {
  ...
  public double getDouble(Object o) { return ((Number)get(o)).doubleValue(); }
  
  public int getInt(Object o) {
    return ((Number)get(o)).intValue();
  }
  
  public boolean getBoolean(Object o) { return ((Boolean)get(o)).booleanValue(); }
  ...
  public Class getValueClass() { return m_valueClass; }
  
  public boolean getIsPersistent() {
    return m_isPersistent;
  }
  
  public String getMixedCaseName() { return m_mixedCaseName; }
  ...
  public String toString() { return m_elementClass.getName() + "." + m_capsAndUnderscoresName + "_PROPERTY"; }
  ...
  public static Vector getProperties(Class cls, boolean persistentOnly, boolean declaredOnly) { Vector v = new Vector();
    Field[] fields;
    Field[] fields; if (declaredOnly) {
  ...
  public static Vector getProperties(Class cls) { return getProperties(cls, false, false); }
  
  public static Property getPropertyMixedCaseNamed(Class cls, String mixedCaseName)
  {
    Enumeration enum0 = getProperties(cls).elements();
  ...
  public static Property getPropertyCapsAndUnderscoresNamed(Class cls, String capsAndUnderscoresName) { Enumeration enum0 = getProperties(cls).elements();
    while (enum0.hasMoreElements()) {
      Property property = (Property)enum0.nextElement();
  ...
  public static Vector getPropertyValuePairs(Object o, boolean persistentOnly, boolean declaredOnly) {
    Vector v = new Vector();
    Enumeration enum0 = getProperties(o.getClass(), persistentOnly, declaredOnly).elements();
    while (enum0.hasMoreElements()) {
      Property property = (Property)enum0.nextElement();
  ...
  public static Vector getPropertyValuePairs(Object o) { return getPropertyValuePairs(o, false, false); }
  ...
  public static StringBuffer convertMixedCaseToAllCapsAndUnderscores(String mixedCase) { StringBuffer allCapsAndUnderscores = new StringBuffer();
