  ...
  extends edu.cmu.cs.stage3.alice.scenegraph.renderer.nativerenderer.IndexedTriangleArrayProxy
{
  ...
  protected native void onIndicesChange(int[] paramArrayOfInt);
  
  protected native void onIndexLowerBoundChange(int paramInt);
  
  protected native void onIndexUpperBoundChange(int paramInt);
}
