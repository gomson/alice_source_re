...
public abstract class Element
{
  ...
  static {
    try { s_printWarnings = Boolean.getBoolean("alice.printWarnings");
    } catch (Throwable t) {
      s_printWarnings = false; } }
  
  public Element() {}
  
  public static void warn(Object o) { if (s_printWarnings)
      System.err.print(o);
  }
  ...
  protected void releasePass2() { m_bonus = null;
    m_name = null;
  }
  
  protected void releasePass3() {
    Enumeration enum0 = m_propertyListeners.elements();
  ...
  public synchronized void release() { if (!m_isReleased) {
  ...
  public Object getBonus() { return m_bonus; }
  ...
  public void addPropertyListener(PropertyListener propertyListener) { m_propertyListeners.addElement(propertyListener);
    m_propertyListenerArray = null;
  }
  ...
  protected void onPropertyChange(PropertyEvent propertyEvent) { Enumeration enum0 = m_propertyListeners.elements();
    while (enum0.hasMoreElements()) {
      PropertyListener propertyListener = (PropertyListener)enum0.nextElement();
  ...
  protected void onPropertyChange(Property property) { if (isReleased()) {
  ...
  public void removeReleaseListener(ReleaseListener releaseListener) { m_releaseListeners.removeElement(releaseListener);
    m_releaseListenerArray = null;
  }
  
  public ReleaseListener[] getReleaseListeners() { if (m_releaseListenerArray == null) {
