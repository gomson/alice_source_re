...
public abstract class AbstractIsEqualTo extends BinaryObjectResultingInBooleanQuestion { public AbstractIsEqualTo() {}
  
  protected boolean isEqualTo(Object aValue, Object bValue) { if (aValue != null) {
      ...
      try
      {
        double a = Double.valueOf(aValue.toString()).doubleValue();
        double b = Double.valueOf(bValue.toString()).doubleValue();
        if (a == b) return true;
        return false;
      } catch (Exception e) {
        return false;
