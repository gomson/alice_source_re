...
public class ListVisualizationWithItemAnimation extends ListVisualizationAnimation {
  ...
  public class RuntimeListVisualizationWithItemAnimation extends ListVisualizationAnimation.RuntimeListVisualizationAnimation { public RuntimeListVisualizationWithItemAnimation() { super(); }
    
    public edu.cmu.cs.stage3.alice.core.Model getItem() { return item.getModelValue(); }
  }
  
  public ListVisualizationWithItemAnimation() {}
}
