...
public class StackVisualizationWithItemAnimation extends StackVisualizationAnimation {
  ...
  public class RuntimeStackVisualizationWithItemAnimation extends StackVisualizationAnimation.RuntimeStackVisualizationAnimation { public RuntimeStackVisualizationWithItemAnimation() { super(); }
    
    public edu.cmu.cs.stage3.alice.core.Model getItem() { return item.getModelValue(); }
  }
  
  public StackVisualizationWithItemAnimation() {}
}
