...
public class ArrayVisualizationAnimation extends edu.cmu.cs.stage3.alice.core.response.Animation {
  ...
  public class RuntimeArrayVisualizationAnimation extends edu.cmu.cs.stage3.alice.core.response.Animation.RuntimeAnimation { public RuntimeArrayVisualizationAnimation() { super(); }
  ...
  public ArrayVisualizationAnimation() {}
}
