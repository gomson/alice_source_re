...
public class ListVisualizationAnimation extends edu.cmu.cs.stage3.alice.core.response.Animation {
  ...
  public class RuntimeListVisualizationAnimation extends edu.cmu.cs.stage3.alice.core.response.Animation.RuntimeAnimation { public RuntimeListVisualizationAnimation() { super(); }
  ...
  public ListVisualizationAnimation() {}
}
