  ...
  extends RenderTargetPickManipulator
{
  ...
  public void mouseReleased(MouseEvent ev)
  {
    if ((ePickedTransformable != null) && (!isActionAborted()) && 
      (AuthoringTool.getHack() != null) && 
      (AuthoringTool.getHack().getUndoRedoStack() != null)) {
      AuthoringTool.getHack().getUndoRedoStack().push(new PointOfViewUndoableRedoable(ePickedTransformable, oldTransformation, new Matrix44(sgPickedTransformable.getLocalTransformation()), AuthoringTool.getHack().getOneShotScheduler()));
    }
