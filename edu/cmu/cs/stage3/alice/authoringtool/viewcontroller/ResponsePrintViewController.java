...
public class ResponsePrintViewController extends DnDGroupingPanel implements GUIElement
{
  ...
  class MouseListener extends CustomMouseAdapter { MouseListener() {}
    ...
    public void popupResponse(MouseEvent ev) { Vector structure = ElementPopupUtilities.getDefaultStructure(printStatement);
      if ((structure != null) && (!structure.isEmpty())) {
        ElementPopupUtilities.createAndShowElementPopupMenu(printStatement, structure, ResponsePrintViewController.this, ev.getX(), ev.getY());
      }
    }
  }
}
